...
```{r}
TabA<-gt(A, rowname_col = c("Clutch Serving Score","Clutch Playing Score","Overall Clutch Score"),
      rownames_to_stub = TRUE)
TabA %>%
  tab_header(
    title = "Clutch Scoring Table",
    subtitle = paste(unique(WData$PlayerID), "data from", min(as.Date(WData$Date)), "to", max(as.Date(WData$Date))))
