...
(AllTable<-TableMaker(AllData))
(MJones<-TableMaker(read.csv("Women's Player Data Files/MJones.csv")))
(AAbramyan<-TableMaker(read.csv("Women's Player Data Files/AAbramyan.csv")))
(KCusick<-TableMaker(read.csv("Women's Player Data Files/KCusick.csv")))
(PMalykh<-TableMaker(read.csv("Women's Player Data Files/PMalykh.csv")))
(SSmith<-TableMaker(read.csv("Women's Player Data Files/SSmith.csv")))
```
