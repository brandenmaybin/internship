...
```{r}
weightedcombo<-function(dataset){
  ...
  rawcombocolumn[1]<-list(
    serves<-unlist(BYUhold[1])[1]+unlist(BYUbreak[1])[1],
    play<-unlist(BYUhold[1])[2]+unlist(BYUbreak[1])[2]+unlist(opphold[1])[1]+unlist(oppbreak[1])[1],
    s&pscore<-unlist(BYUhold[1])[1]+unlist(BYUbreak[1])[1])
