...
FullMatrix<-function(DataSet,DataType="OldSQL"){
  ...
  rownames(MATRIX)<-c("Distribution", "First Serve Distribution", "Second Serve Distribution", "Def Pressure %", "Atk Pressure %", "Ace Distribution", "Ace Probability", "Short Game Win %", "Double Fault %", "Weighted Clutch Serving Score")
  ...
  MATRIX[4,]<-DefPressureDistribution(Deuce,Ad,Joint)
  MATRIX[5,]<-AtkPressureDistribution(Deuce,Ad,Joint)
  MATRIX[6,]<-AceDistFunc(Deuce,Ad,Joint)
  MATRIX[7,]<-AcePercFunc(Deuce,Ad,Joint)
  MATRIX[8,]<-ShortGameWinPerc(Deuce,Ad,Joint)
  MATRIX[9,]<-DFPerc(Deuce,Ad,Joint)
