...
Test Example using the data we have from the 2 intramural test cases with the 2-shot model 
```{r}
Ethan<-read.csv("Ethan Test.csv")[1:71,]
Paul<-read.csv("Paul Test.csv")[1:81,]
TestIntramurals<-rbind(Ethan,Paul)
...
TestFormat<-FormatData(TestIntramurals,DataType = "NewExcel")

FullMatrix(TestFormat)
```

Test Example using the data pulled out of WTennisStats from the SQL table. Year Unknown. 
```{r}
