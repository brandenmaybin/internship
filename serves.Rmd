...
```{r}
#build an example data set out of an intramural match
setwd("C:/Users/opham/OneDrive/Documents/BYU Women's Tennis")
...
deuceadcreator(ethanservingdata)
courtdistfunc(ethandeuce,ethanad,ethanservingdata)
acedistfunc(ethandeuce,ethanad,ethanservingdata)
aceprobfunc(ethandeuce,ethanad,ethanservingdata)
shortgamewinperc(ethandeuce,ethanad,ethanservingdata)
firstcourtdist(ethandeuce,ethanad,ethanservingdata)
secondcourtdist(ethandeuce,ethanad,ethanservingdata)
dfperc(ethandeuce,ethanad,ethanservingdata)
```
